...
const marriageSchema = new mongoose_1.Schema({
    groomName: { type: String, required: true, trim: true },
    brideName: { type: String, required: true, trim: true },
    groomFamilyId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Family' },
    brideFamilyId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Family' },
...
exports.Marriage = mongoose_1.default.model('Marriage', marriageSchema);
