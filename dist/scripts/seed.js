...
const seedDatabase = async () => {
    ...
    await Promise.all([
        ...
        madrasa_extra_model_js_1.MadrasaClass.deleteMany({}),
        madrasa_extra_model_js_1.MadrasaTimetable.deleteMany({}),
        madrasa_extra_model_js_1.MadrasaExamResult.deleteMany({}),
        madrasa_extra_model_js_1.MadrasaFee.deleteMany({}),
        madrasa_extra_model_js_1.MadrasaAttendance.deleteMany({}),
        madrasa_extra_model_js_1.MadrasaAnnouncement.deleteMany({}),
    ...
    const class3A = await madrasa_extra_model_js_1.MadrasaClass.create({
        madrasaId: m1._id,
        name: 'Class 3 - A',
        standard: 3,
        division: 'A',
    ...
    const class6B = await madrasa_extra_model_js_1.MadrasaClass.create({
        madrasaId: m1._id,
        name: 'Class 6 - B',
        standard: 6,
        division: 'B',
    ...
    const maryam = await madrasa_model_js_1.MadrasaStudent.create({
        madrasaId: m1._id,
    ...
    const zaid = await madrasa_model_js_1.MadrasaStudent.create({
        madrasaId: m1._id,
    ...
    const bilal = await madrasa_model_js_1.MadrasaStudent.create({
        madrasaId: m1._id,
    ...
    await madrasa_extra_model_js_1.MadrasaTimetable.create({
        madrasaId: m1._id,
        classId: class3A._id,
        className: 'Class 3 - A',
    ...
    await madrasa_extra_model_js_1.MadrasaExamResult.create({
        madrasaId: m1._id,
    ...
    await madrasa_extra_model_js_1.MadrasaFee.create({
        madrasaId: m1._id,
        studentId: maryam._id,
        familyId: familyRashid._id,
        month: '2026-08',
    ...
    for (const dateStr of pastDates) {
        await madrasa_extra_model_js_1.MadrasaAttendance.create({
            madrasaId: m1._id,
            studentId: maryam._id,
            classId: class3A._id,
    ...
    await madrasa_extra_model_js_1.MadrasaAnnouncement.create([
        {
            madrasaId: m1._id,
